...
function App() {
  ...
  const spinWheel = () => {
    ...
    setTimeout(() => {
      ...
      console.log('最终角度:', finalAngle.toFixed(1) + '°', '抽奖结果:', isWin ? 'BigWin - 中奖!' : 'Thank You - 未中奖')
    }, 3000)
  }
      ...
      <div className="main-frame">
        ...
        <div className="spin-wheel-group">
          ...
          >
            ...
            {/* 转盘文字 - BigWin - 保持竖直 */}
            <div 
              className="prize-text bigwin-text"
            ...
            {/* 转盘文字 - Thank You - 保持竖直 */}
            <div 
              className="prize-text thankyou-text"
              style={{ transform: `rotate(${-rotation}deg)` }}
            >
              Thank<br/>You
            </div>
        ...
        <div className="bottom-button-section">
          ...
          >
            <span className="button-text">
              {isSpinning ? 'Spinning...' : 'Spin to Win Now!'}
            </span>
        </button>
        </div>
              ...
              <div className="modal-content">
                ...
                <div className="modal-main-content">
                  ...
                  <p className="congratulations-subtitle">
                    Please show the screen to our staff<br/>
                    before tapping "OK"
                  </p>
                </div>
