...
const Header = ({ onLogin, onMyPrizes }: HeaderProps) => {
  return (
    <div className="w-full h-[calc(60/375*100vw)] bg-[rgba(39,11,79,0.05)] flex items-center justify-between px-[calc(24/375*100vw)] md:min-h-[calc(120/1920*100vw)] md:px-[calc(240/1920*100vw)]">
      ...
      />
      {/* login / sign up */}
      <div className="w-[calc(125/375*100vw)] h-[calc(31/375*100vw)] flex flex-row items-center justify-center gap-[calc(12/375*100vw)] md:w-[calc(525/1920*100vw)] md:h-[calc(58/1920*100vw)] md:flex md:justify-end md:items-center md:gap-[calc(48/1920*100vw)]">
        {/* 游戏次数 */}
        <div className="hidden md:flex flex-row justify-center items-center gap-[6px] md:w-[calc(87/1920*100vw)] md:h-[calc(58/1920*100vw)]">
          ...
          <span className="font-['Montserrat'] font-normal font-400 text-black md:font-[calc(32/1920*100vw)] md:leading-[calc(16/1920*100vw)] md:w-[calc(123/1920*100vw)] md:h-[calc(20/1920*100vw)] md:text-[calc(32/1920*100vw)]">
            3
          </span>
        </div>
